        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild className="rounded-2xl bg-gradient-to-br from-white/10 to-white/5 hover:from-white/20 hover:to-white/10 transition-all duration-300 border border-white/10 shadow-lg group-data-[collapsible=icon]:p-0 group-data-[collapsible=icon]:size-10 group-data-[collapsible=icon]:rounded-xl group-data-[collapsible=icon]:overflow-hidden group-data-[collapsible=icon]:justify-center">
              <a href="/dashboard">
                <div className="bg-white text-primary flex aspect-square size-8 items-center justify-center rounded-xl shadow-inner group-data-[collapsible=icon]:size-6 group-data-[collapsible=icon]:rounded-lg">
                  <Trophy className="size-5 fill-current group-data-[collapsible=icon]:size-4" />
                </div>
                <div className="grid flex-1 text-left text-sm leading-tight ml-2 group-data-[collapsible=icon]:hidden">
                  <span className="text-lg font-black tracking-tight text-white">slak ajmi</span>
                  <span className="text-[10px] font-medium text-white/60 uppercase tracking-widest">Campus Manager</span>
                </div>
              </a>
            </SidebarMenuButton>
          </SidebarMenuItem>
                ...
                <SidebarMenuItem key={item.title}>
                  ...
                  >
                    <a href={item.url} className="flex items-center gap-3">
                      <item.icon className="size-5 opacity-70 group-hover/item:opacity-100 transition-opacity" />
